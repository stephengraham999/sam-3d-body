# Patch: human_body_prior `pyproject.toml` compatibility for local Python 3.9 / torch 2.8

## Why this patch exists

`human_body_prior` upstream currently requires:
...
- `base_posescript/_vendor_src/human_body_prior/pyproject.toml`
